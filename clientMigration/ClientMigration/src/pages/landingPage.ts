...
export function renderLandingPage(): string {
  ...
  return `
    <div class="landing-container fixed inset-0 flex items-center justify-center overflow-hidden z-[9999]" style="background: url('${backgroundImage}') center/cover no-repeat;">
      ...
      <div class="landing-content relative text-center p-10 animate-fade-in z-10 flex flex-col items-center justify-center gap-5">
        ...
        <div class="press-start font-mono text-2xl md:text-base sm:text-xs text-[#5db3d1] cursor-pointer transition-all duration-300 opacity-0 pointer-events-none" id="press-start">
          PRESS TO START
        </div>
      </div>
    </div>
